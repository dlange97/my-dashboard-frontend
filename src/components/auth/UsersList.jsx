  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        setError(err.message || t("users.loadError", "Failed to load users."));
      } finally {
        setLoading(false);
      }
    }
      ...
      <section className="auth-users-section">
        <div className="auth-users-card">
          <div className="auth-users-card-header">
            <div>
              <h2>{t("users.directory", "Directory")}</h2>
            </div>
          </div>
          ...
          <div className="auth-users-controls">
            ...
            />
            <span className="auth-users-count">
              {t("users.total", "Total:")} {pagination.total}
            </span>
          </div>
              ...
              <table className="auth-users-table">
                <thead>
                  <tr>
                    ...
                    <th>{t("users.colCreated", "Created")}</th>
